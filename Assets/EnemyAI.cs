...
public class EnemyAI : MonoBehaviour
{
    ...
    [SerializeField] private float detectionRadius = 15f;  // Zasięg detekcji gracza
    [SerializeField] private float randomPointRange = 5f;  // Zakres losowego punktu wokół gracza
    [SerializeField] private float separationRadius = 2f;  // Promień separacji od innych wrogów
    [SerializeField] private float repathTime = 2f;        // Czas pomiędzy aktualizacjami ścieżki
